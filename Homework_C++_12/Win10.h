...
// имяннованное перечисление с именем _COLOR
enum _COLOR
{
    black,        // = 0
    blue,         // 1 = black + 1
    ...
    light_purple,
    light_yellow,
    bright_white, // последняя запятая не ошибка
};
...
//  Row - номер строки вывода
//  Col - номер столбца вывода
...
//  bVisible = TRUE/FALSE - показать/скрыть курсор на экране, по умолчанию скрывает курсор
//  dwSize - размер курсора в %, по умолчанию 10%
...
//  nFont - размер шрифта
//  Lines - размер окна по высоте, в строках
//  Columns - размер окна по ширине, в столбцах
